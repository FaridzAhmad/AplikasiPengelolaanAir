...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item <?= (current_url() == base_url('teknisi/pengumuman')) ? 'active' : '' ?>">
                <a class="nav-link" href="<?= base_url('teknisi/pengumuman') ?>">
            ...
            <li class="nav-item <?= (current_url() == base_url('teknisi/keluhan')) ? 'active' : '' ?>">
                <a class="nav-link" href="<?= base_url('teknisi/keluhan') ?>">
                    <i class="fas fa-fw fa-bullhorn"></i>
                    <span>Keluhan</span>
                </a>
            </li>
