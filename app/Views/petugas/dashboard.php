    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item  <?= (current_url() == base_url('petugas/sambungan-baru')) ? 'active' : '' ?>">
                <a class="nav-link" href="<?= base_url('petugas/sambungan-baru') ?>">
                    <i class="fas fa-gauge"></i>
                    <span>Pengajuan Sambungan Baru</span></a>
            </li>

            <li class="nav-item  <?= (current_url() == base_url('petugas/data-meteran')) ? 'active' : '' ?>">
                <a class="nav-link" href="<?= base_url('petugas/data-meteran') ?>">
                    <i class="fas fa-gauge"></i>
                    <span>Input Data Meteran</span></a>
            </li>
